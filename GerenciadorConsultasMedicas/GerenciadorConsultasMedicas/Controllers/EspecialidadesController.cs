...
namespace GerenciadorConsultasMedicas.Controllers
{
    public class EspecialidadesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EspecialidadeID,Nome")] Especialidades especialidades)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EspecialidadeID,Nome")] Especialidades especialidades)
        {
            if (ModelState.IsValid)
            {
