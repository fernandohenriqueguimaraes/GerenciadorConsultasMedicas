...
namespace GerenciadorConsultasMedicas.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PessoaID,CPF,Nome,Sobrenome,Sexo,DataNascimento")] Pessoas pessoas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PessoaID,CPF,Nome,Sobrenome,Sexo,DataNascimento")] Pessoas pessoas)
        {
            if (ModelState.IsValid)
            {
